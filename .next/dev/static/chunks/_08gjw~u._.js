...
function QuizMode({ pairs, answerMode, setAnswerMode, inverted, setInverted }) {
    ...
    const manualInputRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const generateOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "QuizMode.useCallback[generateOptions]": (correctAnswer)=>{
            if (answerMode === "all-values") {
                ...
                const shuffledOthers = uniqueOthers.sort({
    ...
    const handleModeChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "QuizMode.useCallback[handleModeChange]": (newMode)=>{
            setAnswerMode(newMode);
        }
    }["QuizMode.useCallback[handleModeChange]"], [
        setAnswerMode,
        getRandomPair,
        generateQuestion,
        inverted,
    ...
    }["QuizMode.useCallback[handleInvertChange]"], [
        setInverted,
        getRandomPair,
        generateQuestion,
        answerMode,
...
//# sourceMappingURL=_08gjw~u._.js.map