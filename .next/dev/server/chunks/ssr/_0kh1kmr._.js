...
;
;
function QuizMode({ pairs, answerMode, setAnswerMode }) {
    ...
    const generateOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((correctValue)=>{
        if (answerMode === "all-values") {
            ...
            const otherValues = validPairs.filter((p)=>p.value !== correctValue).map((p)=>p.value);
    ...
    const nextQuestion = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        ...
        if (newPair) {
            ...
            if (answerMode !== "manual") {
                setOptions(generateOptions(newPair.value));
            }
            setSelectedAnswer("");
            setManualInput("");
            setFeedback(null);
    ...
    const handleAnswer = (answer)=>{
        ...
        const isCorrect = answer === currentPair.value;
        if (isCorrect) {
            setFeedback("success");
                        ...
                        children: [
                            ...
                            answerMode === "manual" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: options.map((option, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        disabled: !!feedback,
                                        variant: feedback === "success" && option === currentPair.value ? "default" : feedback === "error" && option === currentPair.value ? "default" : feedback === "error" && option === selectedAnswer ? "destructive" : "outline",
...
//# sourceMappingURL=_0kh1kmr._.js.map